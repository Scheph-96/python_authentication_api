...
## Overview
For a standalone authentication api their are only a few collections to validate data and authenticate users. So we have users, email_validation_code, password_recovery_token, refresh_tokens. (You might want to forgive my poor naming skill)
