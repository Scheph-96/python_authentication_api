...
class RefreshToken:
    ...
    def __init__(self, user_id: str, token_hash: str, auth_version: int, replaced_by: str = None, revoked: bool = False, _id: ObjectId = None, expire_at: datetime | None = None, created_at: datetime | None = None):
