...
class RolePermissionService:
    ...
    def find_role_permission_by_role_id(self, role_id: str) -> list:
        return self.role_permission_repository.find_by_role_id(role_id)

    def find_role_permission_by_permission_id(self, permission_id: str) -> list:
        return self.role_permission_repository.find_by_permission_id(permission_id)
